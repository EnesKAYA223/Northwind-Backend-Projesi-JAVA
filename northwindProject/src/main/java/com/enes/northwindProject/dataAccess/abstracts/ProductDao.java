...
package com.enes.northwindProject.dataAccess.abstracts;
...
public interface ProductDao extends JpaRepository<Product, Integer> {
	...
	@Query("Select new  com.enes.northwindProject.entities.dtos.ProductWithCategoryDto(p.id,p.productName,c.categoryName)"
