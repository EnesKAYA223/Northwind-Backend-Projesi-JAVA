...
import com.enes.northwindProject.core.utilities.results.ErrorDataResult;
...
public class UsersController {
	...
	public ErrorDataResult<Object> handleValidationException(MethodArgumentNotValidException exceptions){
		...
		ErrorDataResult<Object> errors=new ErrorDataResult<>(validationError,"Dogrulama Hatalari");
